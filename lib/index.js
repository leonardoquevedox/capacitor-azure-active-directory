...
const ActiveDirectoryPlugin = () => {
  ...
  ActiveDirectoryPlugin = function (config) {
    /**
    ...
    if (ActiveDirectoryPlugin.prototype._singletonInstance) {
      return ActiveDirectoryPlugin.prototype._singletonInstance
    }
    ActiveDirectoryPlugin.prototype._singletonInstance = this
   ...
   */
  ActiveDirectoryPlugin.prototype.login = function () {
   ...
   * @ignore
   */
  ActiveDirectoryPlugin.prototype._openPopup = function (
    urlNavigate,
    title,
    popUpWidth,
    popUpHeight,
  ...
  ActiveDirectoryPlugin.prototype._handlePopupError = function (
    loginCallback,
    resource,
    error,
    errorDesc,
   ...
   * @ignore
   */
  ActiveDirectoryPlugin.prototype._loginPopup = function (urlNavigate, resource, callback) {
  ...
  ActiveDirectoryPlugin.prototype._broadcast = function (eventName, data) {
  ...
  ActiveDirectoryPlugin.prototype.loginInProgress = function () {
   ...
   */
  ActiveDirectoryPlugin.prototype._hasResource = function (key) {
   ...
   */
  ActiveDirectoryPlugin.prototype.getCachedToken = function (resource) {
   ...
   */
  ActiveDirectoryPlugin.prototype.getCachedUser = function () {
    if (this._user) {
      return this._user
    }
   ...
   */
  ActiveDirectoryPlugin.prototype.registerCallback = function (expectedState, resource, callback) {
   ...
   * @ignore
   */
  ActiveDirectoryPlugin.prototype._renewToken = function (resource, callback, responseType) {
   ...
   * @ignore
   */
  ActiveDirectoryPlugin.prototype._renewIdToken = function (callback, responseType) {
    // use iframe to try to renew token
   ...
   * @ignore
   */
  ActiveDirectoryPlugin.prototype._urlContainsQueryStringParameter = function (name, url) {
   ...
   * @ignore
   */
  ActiveDirectoryPlugin.prototype._urlRemoveQueryStringParameter = function (url, name) {
   ...
   * @ignore
   */
  ActiveDirectoryPlugin.prototype._loadFrameTimeout = function (
    urlNavigation,
    frameName,
    resource,
  ) {
   ...
   * @ignore
   */
  ActiveDirectoryPlugin.prototype._loadFrame = function (urlNavigate, frameName) {
   ...
   * @param {tokenCallback} callback -  The callback provided by the caller. It will be called with token or error.
   */
  ActiveDirectoryPlugin.prototype.acquireToken = function (resource, callback) {
   ...
   * @param {tokenCallback} callback -  The callback provided by the caller. It will be called with token or error.
   */
  ActiveDirectoryPlugin.prototype.acquireTokenPopup = function (
    resource,
   ...
   * @param {string}   extraQueryParameters  extraQueryParameters to add to the authentication request
   */
  ActiveDirectoryPlugin.prototype.acquireTokenRedirect = function (
    resource,
    extraQueryParameters,
    claims,
  ) {
   ...
   */
  ActiveDirectoryPlugin.prototype.promptUser = function (urlNavigate) {
    if (urlNavigate) {
   ...
   * Clears cache items.
   */
  ActiveDirectoryPlugin.prototype.clearCache = function () {
   ...
   */
  ActiveDirectoryPlugin.prototype.clearCacheForResource = function (resource) {
    this._saveItem(this.CONSTANTS.STORAGE.STATE_RENEW, '')
    this._saveItem(this.CONSTANTS.STORAGE.ERROR, '')
    this._saveItem(this.CONSTANTS.STORAGE.ERROR_DESCRIPTION, '')
   ...
   */
  ActiveDirectoryPlugin.prototype.logOut = function () {
    this.clearCache()
    this._user = null
    var urlNavigate
  ...
  ActiveDirectoryPlugin.prototype._isEmpty = function (str) {
   ...
   */
  ActiveDirectoryPlugin.prototype.getUser = function (callback) {
   ...
   * @ignore
   */
  ActiveDirectoryPlugin.prototype._addHintParameters = function (urlNavigate) {
   ...
   * @ignore
   */
  ActiveDirectoryPlugin.prototype._createUser = function (idToken) {
    var user = null
   ...
   * @ignore
   */
  ActiveDirectoryPlugin.prototype._getHash = function (hash) {
    if (hash.indexOf('#/') > -1) {
   ...
   */
  ActiveDirectoryPlugin.prototype.isCallback = function (hash) {
   ...
   */
  ActiveDirectoryPlugin.prototype.getLoginError = function () {
   ...
   */
  ActiveDirectoryPlugin.prototype.getRequestInfo = function (hash) {
    hash = this._getHash(hash)
    var parameters = this._deserialize(hash)
    var requestInfo = {
      valid: false,
   ...
   * @ignore
   */
  ActiveDirectoryPlugin.prototype._matchNonce = function (user) {
   ...
   * @ignore
   */
  ActiveDirectoryPlugin.prototype._matchState = function (requestInfo) {
   ...
   * @ignore
   */
  ActiveDirectoryPlugin.prototype._getResourceFromState = function (state) {
    if (state) {
   ...
   */
  ActiveDirectoryPlugin.prototype.saveTokenFromHash = function (requestInfo) {
    this.info(
   ...
   */
  ActiveDirectoryPlugin.prototype.getResourceForEndpoint = function (endpoint) {
   ...
   * @ignore
   */
  ActiveDirectoryPlugin.prototype._getHostFromUri = function (uri) {
   ...
   */
  ActiveDirectoryPlugin.prototype.handleWindowCallback = function (hash) {
   ...
   * @ignore
   */
  ActiveDirectoryPlugin.prototype._getNavigateUrl = function (responseType, resource) {
    var tenant = 'common'
    if (this.config.tenant) {
      tenant = this.config.tenant
    }
   ...
   * @ignore
   */
  ActiveDirectoryPlugin.prototype._extractIdToken = function (encodedIdToken) {
   ...
   * @ignore
   */
  ActiveDirectoryPlugin.prototype._base64DecodeStringUrlSafe = function (base64IdToken) {
  ...
  ActiveDirectoryPlugin.prototype._decode = function (base64IdToken) {
  ...
  ActiveDirectoryPlugin.prototype._decodeJwt = function (jwtToken) {
   ...
   * @ignore
   */
  ActiveDirectoryPlugin.prototype._convertUrlSafeToRegularBase64EncodedString = function (str) {
   ...
   * @ignore
   */
  ActiveDirectoryPlugin.prototype._serialize = function (responseType, obj, resource) {
    var str = []
   ...
   * @ignore
   */
  ActiveDirectoryPlugin.prototype._deserialize = function (query) {
    var match,
   ...
   * @ignore
   */
  ActiveDirectoryPlugin.prototype._decimalToHex = function (number) {
   ...
   */
  /* jshint ignore:start */
  ActiveDirectoryPlugin.prototype._guid = function () {
   ...
   * @ignore
   */
  ActiveDirectoryPlugin.prototype._expiresIn = function (expires) {
   ...
   * @ignore
   */
  ActiveDirectoryPlugin.prototype._now = function () {
   ...
   * @ignore
   */
  ActiveDirectoryPlugin.prototype._addAdalFrame = function (iframeId) {
   ...
   * @ignore
   */
  ActiveDirectoryPlugin.prototype._saveItem = function (key, obj, preserve) {
   ...
   * @ignore
   */
  ActiveDirectoryPlugin.prototype._getItem = function (key) {
    if (this.config && this.config.cacheLocation && this.config.cacheLocation === 'localStorage') {
      if (!this._supportsLocalStorage()) {
        this.info('Local storage is not supported')
        return null
   ...
   * @ignore
   */
  ActiveDirectoryPlugin.prototype._supportsLocalStorage = function () {
    try {
   ...
   * @ignore
   */
  ActiveDirectoryPlugin.prototype._supportsSessionStorage = function () {
    try {
   ...
   * @ignore
   */
  ActiveDirectoryPlugin.prototype._cloneConfig = function (obj) {
   ...
   * @ignore
   */
  ActiveDirectoryPlugin.prototype._addLibMetadata = function () {
    // x-client-SKU
    // x-client-Ver
   ...
   */
  ActiveDirectoryPlugin.prototype.log = function (level, message, error, containsPii) {
   ...
   * @param {string} error  -  Error to log.
   */
  ActiveDirectoryPlugin.prototype.error = function (message, error) {
   ...
   * @param {string} message  -  Message to log.
   */
  ActiveDirectoryPlugin.prototype.warn = function (message) {
   ...
   * @param {string} message  -  Message to log.
   */
  ActiveDirectoryPlugin.prototype.info = function (message) {
   ...
   * @param {string} message  -  Message to log.
   */
  ActiveDirectoryPlugin.prototype.verbose = function (message) {
   ...
   * @param {string} error  -  Error to log.
   */
  ActiveDirectoryPlugin.prototype.errorPii = function (message, error) {
   ...
   * @param {string} message  -  Message to log.
   */
  ActiveDirectoryPlugin.prototype.warnPii = function (message) {
   ...
   * @param {string} message  -  Message to log.
   */
  ActiveDirectoryPlugin.prototype.infoPii = function (message) {
   ...
   * @param {string} message  -  Message to log.
   */
  ActiveDirectoryPlugin.prototype.verbosePii = function (message) {
   ...
   * @ignore
   */
  ActiveDirectoryPlugin.prototype._libVersion = function () {
    return '1.0.17'
  }
  ...
  if (typeof module !== 'undefined' && module.exports) {
    module.exports = ActiveDirectoryPlugin
    module.exports.inject = function (conf) {
      return new ActiveDirectoryPlugin(conf)
    }
  }
