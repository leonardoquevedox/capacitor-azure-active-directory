...
class ActiveDirectoryPlugin {
  ...
  getCachedToken(resource = '') {
    const token = this._getItem(this.CONSTANTS.STORAGE.NONCE_IDTOKEN + resource) || ''
    ...
    if (expiry && expiry > this._now() + offset) {
      ...
      this._saveItem(this.CONSTANTS.STORAGE.NONCE_IDTOKEN + resource, '')
      this._saveItem(
        this.CONSTANTS.STORAGE.EXPIRATION_KEY + resource,
        this.CONSTANTS.DEFAULT_EXPIRATION_TIME,
      )
      return null
    }
  }
